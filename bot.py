...
def send_welcome(message):
    bot.reply_to(message, 'Hola! I am a bot created by KKK2504 converts Files to Link .Send me any file (Video, Audio, Photo, Document)👇🏻')

@bot.message_handler(commands=['help'])
def send_welcome(message):
    bot.reply_to(message, 'Send me any type of  file and you will receive the shorten link of it')    
